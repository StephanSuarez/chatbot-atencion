...
Estado actual: proyecto nuevo, sin código.
...
|-----|---------|----------|------------|--------|
| 001 | Configuración del chatbot | Editar la única configuración del chatbot: nombre de la empresa, prompt de comportamiento (con uno por defecto) y proveedor de LLM, modelo y API key | — | En ejecución (Jira KAN-1) |
